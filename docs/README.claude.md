...
Use this skill for Godot 4.x GDScript, C#, scenes, resources, 2D, 3D, UI, physics, navigation, rendering, shaders, import/export, version upgrade, and validation work.
