...
Answers from Godot 3.x memory or stale 4.x assumptions | Godot 4 changed scene/resource format, physics defaults, class names, C#/.NET support, export behavior, and migration rules | Detect the project version first, then check the local official docs, online docs, or class reference before giving exact API/version guidance
